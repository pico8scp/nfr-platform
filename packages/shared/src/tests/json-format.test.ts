...
const testTurnAttachment: TurnAttachment = {
  id: 'attach-001',
  turnId: 'turn-001',
  kind: 'code',
  mimeType: 'text/plain',
...
const testMemoryLink: MemoryLink = {
  id: 'link-001',
  fromTurnId: 'turn-001',
  toTurnId: 'turn-002',
  linkType: 'related',
...
const testAgentMessage: AgentMessage = {
  id: 'msg-001',
  taskId: 'task-001',
...
const testSystemEvent: SystemEvent = {
  id: 'event-001',
  topic: 'agent.status',
...
const testPaginatedResponse: PaginatedResponse<Turn> = {
  items: [testTurn],
  total: 1,
  limit: 10,
  offset: 0,
...
const testMemoryEntry: MemoryEntry = {
  id: 'mem-001',
  sessionId: 'session-001',
...
const testMemorySearchParams: MemorySearchParams = {
  query: 'test query',
  sessionId: 'session-001',
  conversationId: 'conv-001',
  role: 'user',
...
const testMemorySearchResult: MemorySearchResult = {
  turns: [testTurn],
  total: 1,
}
...
describe('JSON Format Validation Tests', () => {
  ...
  describe('Turn', () => {
    ...
    it('should deserialize JSON to Turn', () => {
      const json = JSON.stringify(testTurn)
      const parsed = JSON.parse(json) as Turn
  ...
  describe('TurnAttachment', () => {
    ...
    it('should deserialize JSON to TurnAttachment', () => {
      const json = JSON.stringify(testTurnAttachment)
      const parsed = JSON.parse(json) as TurnAttachment
  ...
  describe('MemoryLink', () => {
    ...
    it('should deserialize JSON to MemoryLink', () => {
      const json = JSON.stringify(testMemoryLink)
      const parsed = JSON.parse(json) as MemoryLink
  ...
  describe('AgentTask', () => {
    ...
    it('should deserialize JSON to AgentTask', () => {
      const json = JSON.stringify(testAgentTask)
      const parsed = JSON.parse(json) as AgentTask
      expect(parsed).toEqual(testAgentTask)
    })

    it('should have valid status enum', () => {
      expect(testAgentTask.status).toMatch(
  ...
  describe('AgentMessage', () => {
    ...
    it('should deserialize JSON to AgentMessage', () => {
      const json = JSON.stringify(testAgentMessage)
      const parsed = JSON.parse(json) as AgentMessage
  ...
  describe('Skill', () => {
    ...
    it('should have valid handlerType enum', () => {
      expect(testSkill.handlerType).toMatch(
        /^(internal_function|agent_task|mcp_tool_proxy|prompt_template)$/
      )
    })
  })
  ...
  describe('SkillRun', () => {
    ...
    it('should deserialize JSON to SkillRun', () => {
      const json = JSON.stringify(testSkillRun)
      const parsed = JSON.parse(json) as SkillRun
  ...
  describe('McpServer', () => {
    ...
    it('should deserialize JSON to McpServer', () => {
      const json = JSON.stringify(testMcpServer)
      const parsed = JSON.parse(json) as McpServer
  ...
  describe('McpTool', () => {
    ...
    it('should deserialize JSON to McpTool', () => {
      const json = JSON.stringify(testMcpTool)
      const parsed = JSON.parse(json) as McpTool
  ...
  describe('SystemEvent', () => {
    ...
    it('should deserialize JSON to SystemEvent', () => {
      const json = JSON.stringify(testSystemEvent)
      const parsed = JSON.parse(json) as SystemEvent
  ...
  describe('PaginatedResponse', () => {
    ...
    it('should deserialize JSON to PaginatedResponse', () => {
      const json = JSON.stringify(testPaginatedResponse)
      const parsed = JSON.parse(json) as PaginatedResponse<Turn>
  ...
  describe('MemorySearchParams', () => {
    ...
    it('should deserialize JSON to MemorySearchParams', () => {
      const json = JSON.stringify(testMemorySearchParams)
      const parsed = JSON.parse(json) as MemorySearchParams
  ...
  describe('MemorySearchResult', () => {
    ...
    it('should deserialize JSON to MemorySearchResult', () => {
      const json = JSON.stringify(testMemorySearchResult)
      const parsed = JSON.parse(json) as MemorySearchResult
